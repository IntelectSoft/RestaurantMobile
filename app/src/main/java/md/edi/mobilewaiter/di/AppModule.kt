package md.edi.mobilewaiter.di
...
import md.edi.mobilewaiter.data.repo.RemoteApiInterface
import md.edi.mobilewaiter.di.annotations.OkHttpNoAuthInterceptor
import md.edi.mobilewaiter.di.annotations.RetrofitNoAuthInterceptor
